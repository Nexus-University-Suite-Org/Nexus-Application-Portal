...
import org.nexus.napbackend.facade.AlumniFacade;
...
public class AdminAlumniController {
    ...
    private final AlumniFacade facade;

    public AdminAlumniController(AlumniFacade facade) {
        this.facade = facade;
    }

    @GetMapping
    public ResponseEntity<List<AlumniResponse>> list(
