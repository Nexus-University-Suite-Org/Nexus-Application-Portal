...
import org.nexus.napbackend.facade.NewsArticleFacade;
...
public class AdminNewsArticleController {
    ...
    private final NewsArticleFacade facade;

    public AdminNewsArticleController(NewsArticleFacade facade) {
        this.facade = facade;
    }

    @GetMapping
    public ResponseEntity<List<NewsArticleResponse>> list(
