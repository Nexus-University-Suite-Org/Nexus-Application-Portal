...
public class SiteSettingDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            seedIfEmpty("partners_stats_description", "We are grateful to work with organisations and individuals who share our vision of empowerment through practical education.");
            seedIfEmpty("partners_stats", "[{\"value\":\"4\",\"label\":\"Active Partners\"},{\"value\":\"$240K\",\"label\":\"Funds Mobilised\"},{\"value\":\"1,200+\",\"label\":\"Students Supported\"},{\"value\":\"6\",\"label\":\"Countries Represented\"}]");
